...
<body>
    ...
    <div x-transition:leave="transition ease-in duration-300" x-transition:leave-start="opacity-100"
        ...
        <div class="flex h-screen w-full" x-transition:enter="transition ease-out duration-300"
            ...
            <div class="m-auto">
                <div>
                    <div
                        ...
                        <span class="pl-2 mx-1">Edit Task: {{ $task->title }}</span>
                    </div>
                        ...
                        <form action="{{ route('tasks.update', ['task' => $task->id]) }}" method="POST">
                            ...
                            <div class="flex">
                                <div class="flex-1 py-5 pl-5 overflow-hidden">
                                    <h1 class="inline text-2xl font-semibold leading-none">Edit Task</h1>
                                </div>
                            </div>
                            <div class="px-5 pb-5">
                                ...
                                <textarea name="description" placeholder="Description"
                                    class=" text-black placeholder-gray-600 w-full px-4 py-2.5 mt-2 text-base transition duration-500 ease-in-out transform border-transparent rounded-lg bg-gray-200  focus:border-blueGray-500  focus:outline-none focus:shadow-outline focus:ring-2 ring-offset-current ring-offset-2 ring-gray-400">{{ $task->description }}</textarea>
                            </div>
                            ...
                            <div class="flex flex-row-reverse p-3">
                                ...
                                <div class="flex-initial">
                                    <a href="{{ route('user.dashboard', ['id' => request('id')]) }}"
                                        class="flex items-center px-5 py-2.5 font-medium no-underline tracking-wide text-black capitalize rounded-md hover:bg-red-200 hover:fill-current hover:text-red-600 focus:outline-none transition duration-300 transform active:scale-95 ease-in-out ">
                                        <span class="pl-2 mx-1">X Close</span>
                                    </a>
                                </div>
                            </div>
                        </form>
